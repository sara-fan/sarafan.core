...
namespace Sarafan.Core.Data.Migrations
{
    ...
    [Migration("20260921155120_0_3_0_ServiceCatalogue")]
            ...
            modelBuilder.Entity("Sarafan.Core.Models.ServiceCatalogueEntry", b =>
                {
                    ...
                    b.ToTable("service_catalogue_entries", null, t =>
                        {
                            t.HasCheckConstraint("ck_service_catalogue_currency", "currency IS NULL OR currency IN (643, 840)");

                            t.HasCheckConstraint("ck_service_catalogue_method", "price_method IN (0, 100, 200)");
                            ...
                            t.HasCheckConstraint("ck_service_catalogue_period", "available_by IS NULL OR available_by >= available_from");
