...
internal sealed class BackofficeRefreshSessionConfiguration : IEntityTypeConfiguration<BackofficeRefreshSession>
{
    public void Configure(EntityTypeBuilder<BackofficeRefreshSession> builder)
    {
        builder.ToTable("backoffice_refresh_sessions");
        ...
        builder.HasIndex(item => new { item.BackofficeUserId, item.FamilyId });
