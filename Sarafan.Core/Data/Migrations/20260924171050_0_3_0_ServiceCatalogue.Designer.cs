            ...
            modelBuilder.Entity("Sarafan.Core.Models.ServiceCatalogueEntry", b =>
                {
                    ...
                    b.ToTable("service_catalogue_entries", null, t =>
                        {
                            t.HasCheckConstraint("ck_service_catalogue_bands", "(price_method = 400 AND interval_currency IS NOT NULL AND interval_currency IN (643, 840) AND valid_service_price_bands(bands)) OR (price_method <> 400 AND interval_currency IS NULL AND bands = '[]'::jsonb)");
